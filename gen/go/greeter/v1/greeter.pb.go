...
type GreetResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Changed       string                 `protobuf:"bytes,1,opt,name=changed,proto3" json:"changed,omitempty"`
	ImportantNote string                 `protobuf:"bytes,2,opt,name=important_note,json=importantNote,proto3" json:"important_note,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *GreetResponse) GetChanged() string {
	if x != nil {
		return x.Changed
	}
	return ""
...
func (x *GreetResponse) GetImportantNote() string {
	if x != nil {
...
const file_greeter_v1_greeter_proto_rawDesc = "" +
	...
	"\bnachname\x18\x02 \x01(\tR\bnachname\"P\n" +
	"\rGreetResponse\x12\x18\n" +
	"\achanged\x18\x01 \x01(\tR\achanged\x12%\n" +
	"\x0eimportant_note\x18\x02 \x01(\tR\rimportantNote2N\n" +
